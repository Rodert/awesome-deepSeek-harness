...
> Eine kuratierte Liste von DeepSeek-Harness-Plugins, Tools und Begleitprojekten.
...
Automatisch aus GitHub-Projektdaten aktualisiert, mit redaktionell gepflegten Beschreibungen. Projekte und Korrekturen sind willkommen.

Online ansehen：[GitHub Pages](https://rodert.github.io/awesome-deepSeek-harness/de/)
...
- [Plugins](#plugins)
- [Integrationen und Agents](#integrations)
- [Oberflächen (TUI / Desktop / Web)](#interfaces)
- [Ökosystem und Marktplätze](#ecosystem)
- [Themes und Skins](#themes)
- [Weitere Projekte](#other)

> Projekte：**195** · Zuletzt aktualisiert：**2026-09-19**

## Automatische Updates

Der Collector findet DeepSeek-Harness-Repositories über GitHub Search und aktualisiert Sterne, Sprachen, Topics und Zeitstempel. Pushes nach `main` und der tägliche Zeitplan starten die Aktualisierung.

```bash
GITHUB_TOKEN=dein_token python scripts/collect_projects.py
...
*Plugins für Dateiverweise, Vision, Gedächtnis und weitere Funktionen.*

### 1. [deepseek-harness](https://github.com/deepseek-ai/deepseek-harness)

⭐ 229,219 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 66,878 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 47,034 · Python · Aktualisiert 2026-09-19
...
⭐ 27,223 · TypeScript · Aktualisiert 2026-09-19
...
Tags: `aliyun-oss` `cloudflare-r2` `dsh-plugin` `electron` `electron-app` `electron-vue` `github` `image`

### 5. [WeKnora](https://github.com/Tencent/WeKnora)

⭐ 27,028 · Go · Aktualisiert 2026-09-19
...
⭐ 24,867 · Python · Aktualisiert 2026-09-19

Distilly — Distill how they think into reusable Skills for any Agent or Bot. Formerly Colleague Skill（原同事 Skill）.

Tags: `agent-skills` `agentic-ai` `ai-agent` `ai-agents` `ai-assistants` `ai-persona` `claude-code` `claude-skills`

### 7. [colleague-skill](https://github.com/titanwings/colleague-skill)

⭐ 23,809 · Python · Aktualisiert 2026-08-23
...
⭐ 20,186 · JavaScript · Aktualisiert 2026-09-19
...
Tags: `ai` `ai-agent` `artificial-intelligence` `chatgpt` `claude` `claude-code` `codex` `cursor`

### 9. [awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin)

⭐ 16,196 · Python · Aktualisiert 2026-09-19
...
⭐ 15,366 · TypeScript · Aktualisiert 2026-09-19

Harness engineering beginner tutorial, from 0 to 1

Tags: `agent` `agentic` `agentic-ai` `ai` `ai-agent` `ai-agents` `dsh` `dsh-plugin`

### 11. [EverOS](https://github.com/EverMind-AI/EverOS)

⭐ 13,056 · Python · Aktualisiert 2026-09-19

One portable memory layer for every AI agent: local-first, Markdown-native, user-owned, and self-evolving across apps, tools, and workflows.

Tags: `agent-memory` `agentic-ai` `ai` `chats` `clawdbot` `clawdbot-skill` `deepseek-harness` `dsh`

### 12. [MemOS](https://github.com/MemTensor/MemOS)

⭐ 11,459 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 7,246 · Python · Aktualisiert 2026-09-19
...
⭐ 7,194 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 6,932 · Python · Aktualisiert 2026-09-19
...
⭐ 6,355 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 6,032 · Python · Aktualisiert 2026-09-19
...
⭐ 5,893 · Python · Aktualisiert 2026-09-19
...
⭐ 5,360 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 4,129 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 3,809 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 3,589 · TypeScript · Aktualisiert 2026-09-01
...
⭐ 3,488 · Python · Aktualisiert 2026-09-18

ReMe: Memory Management Kit for Agents - Remember Me, Refine Me.

Tags: `agent` `ai-agents` `dsh-plugin` `memory` `memoryscope` `openclaw` `openclaw-plugin` `qwenpaw`

### 24. [OpenBiliClaw](https://github.com/whiteguo233/OpenBiliClaw)

⭐ 3,335 · Python · Aktualisiert 2026-09-19
...
⭐ 3,019 · Python · Aktualisiert 2026-08-22
...
⭐ 1,734 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 1,725 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 1,436 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 1,420 · JavaScript · Aktualisiert 2026-08-27

AI code reviews grounded in 12 classic engineering books — decay risk diagnostics with book citations, severity labels, and 6 analysis modes including full-sweep auto-fix

Tags: `agent-skills` `ai-code-review` `architecture-review` `auto-fix` `claude-code` `claude-code-plugin` `clean-architecture` `code-health`

### 32. [dsh-im](https://github.com/xmanrui/dsh-im)

⭐ 1,391 · JavaScript · Aktualisiert 2026-09-18

通过扫码或机器人凭据把IM机器人接入DeepSeek Harness（支持飞书、微信、钉钉、企业微信、QQ、Slack、Telegram、Discord和WhatsApp）。 Connect IM bots to DeepSeek Harness via QR code or credentials (9 channels).

Tags: `ai-agents` `chatbot` `cordis` `deepseek` `deepseek-harness` `dingtalk-bot` `discord-bot` `dsh`

### 33. [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge)

⭐ 1,380 · JavaScript · Aktualisiert 2026-09-19

DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；默认提示词面向国模「小码酱」。Jailbreak for every model — swap prompts per model. 求 Star 收藏 ⭐

Tags: `dsh-plugin` `dsh-plugins` `harness-jailbreak` `llm-jailbreak`

### 34. [mem9](https://github.com/mem9-ai/mem9)

⭐ 1,198 · TypeScript · Aktualisiert 2026-08-23
...
⭐ 1,154 · C# · Aktualisiert 2026-09-09
...
⭐ 1,144 · HTML · Aktualisiert 2026-08-22
...
⭐ 1,093 · Python · Aktualisiert 2026-08-22

Make AI coding agents architecture-aware: baseline-first, evidence-verified, drift-checked, and safe across long tasks.

Tags: `agent-skills` `ai-agents` `ai-coding` `architecture-driven-development` `awsome-coding-plugin` `baseline-first` `claude-code` `codex`
...
⭐ 1,038 · N/A · Aktualisiert 2026-08-20
...
Tags: `agent-skills` `ai-agent` `benchmark` `deepseek` `deepseek-harness` `dsh` `dsh-plugin`

### 39. [awesome-dsh-plugin](https://github.com/Anil-matcha/awesome-dsh-plugin)

⭐ 1,013 · N/A · Aktualisiert 2026-09-16

A curated list of plugins for DeepSeek Harness (dsh) - DeepSeek Harness plugin ecosystem

Tags: `agent-harness` `ai-agent` `ai-agents` `autonomous-agent` `awesome` `awesome-list` `cli` `coding-agent`

### 40. [MindMemOS](https://github.com/mindscale-noah/MindMemOS)

⭐ 944 · Python · Aktualisiert 2026-08-20

Noch keine Projektbeschreibung.

Tags: `agent` `agent-memory` `agent-skills` `agentic` `dsh-plugin` `dsh-plugins` `openclaw` `openclaw-agent`

### 41. [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit)

⭐ 882 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 792 · HTML · Aktualisiert 2026-09-18
...
⭐ 668 · PowerShell · Aktualisiert 2026-08-31
...
⭐ 511 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 511 · Python · Aktualisiert 2026-09-18
...
⭐ 505 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 469 · Kotlin · Aktualisiert 2026-09-18
...
⭐ 465 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 438 · TypeScript · Aktualisiert 2026-09-18
...
Tags: `ai-agent` `ai-image-generation-api` `comfyui` `deepseek` `deepseek-harness` `dsh-plugin` `gemini` `image-generation`

### 53. [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file)

⭐ 437 · JavaScript · Aktualisiert 2026-08-21
...
⭐ 419 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 419 · JavaScript · Aktualisiert 2026-09-18
...
Tags: `agent-tools` `ai-agents` `android-emulation` `anti-detect-browser` `browser-automation` `browser-fingerprinting` `deepseek-harness` `dsh`

### 56. [dsh-synapse](https://github.com/liangmianya/dsh-synapse)

⭐ 407 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 385 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 378 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 371 · Python · Aktualisiert 2026-09-18
...
⭐ 369 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 365 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 357 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 344 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 318 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 312 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 284 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 273 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 262 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 216 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 204 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 199 · TypeScript · Aktualisiert 2026-09-17
...
⭐ 197 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 189 · TypeScript · Aktualisiert 2026-09-17
...
⭐ 188 · TypeScript · Aktualisiert 2026-09-18

Noch keine Projektbeschreibung.

### 78. [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review)

⭐ 182 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 180 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 180 · JavaScript · Aktualisiert 2026-09-15
...
⭐ 179 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 175 · JavaScript · Aktualisiert 2026-09-17
...
⭐ 173 · TypeScript · Aktualisiert 2026-09-07
...
⭐ 164 · JavaScript · Aktualisiert 2026-09-10
...
⭐ 159 · TypeScript · Aktualisiert 2026-09-08
...
⭐ 158 · Python · Aktualisiert 2026-08-24
...
⭐ 153 · JavaScript · Aktualisiert 2026-09-10
...
⭐ 150 · TypeScript · Aktualisiert 2026-09-07
...
⭐ 148 · JavaScript · Aktualisiert 2026-09-07
...
⭐ 139 · JavaScript · Aktualisiert 2026-09-03
...
⭐ 136 · JavaScript · Aktualisiert 2026-09-01
...
⭐ 128 · TypeScript · Aktualisiert 2026-08-29
...
⭐ 126 · TypeScript · Aktualisiert 2026-08-30
...
⭐ 123 · HTML · Aktualisiert 2026-08-28
...
⭐ 118 · JavaScript · Aktualisiert 2026-08-26
...
⭐ 108 · TypeScript · Aktualisiert 2026-08-24
...
⭐ 105 · Python · Aktualisiert 2025-12-24
...
⭐ 96 · JavaScript · Aktualisiert 2026-08-22
...
⭐ 94 · TypeScript · Aktualisiert 2026-08-21
...
⭐ 84 · HTML · Aktualisiert 2026-08-20
...
⭐ 80 · JavaScript · Aktualisiert 2026-05-18

Noch keine Projektbeschreibung.

### 107. [hello-dsh](https://github.com/pingfanfan/hello-dsh)

⭐ 78 · Python · Aktualisiert 2026-08-19
...
⭐ 74 · Python · Aktualisiert 2026-08-19
...
<a id="integrations"></a>
## Integrationen und Agents

*Projekte zur Verbindung von Harness mit Datenbanken, Design-Tools und Workflows.*

### 1. [openpencil](https://github.com/ZSeven-W/openpencil)

⭐ 5,977 · Rust · Aktualisiert 2026-09-18

The world's first open-source AI-native vector design tool and the first to feature concurrent Agent Teams. Design-as-Code. Turn prompts into UI directly on the live canvas. A modern alternative to Pencil.

Tags: `agent` `agent-team` `ai` `claude` `claude-code` `codex` `dsh-plugin` `fimga`

### 2. [modlens](https://github.com/liustack/modlens)

⭐ 3,985 · TypeScript · Aktualisiert 2026-09-19

The first vision plugin for DeepSeek Harness, and the vision bridge for every text-only coding agent. Paste an image, get structured JSON evidence (OCR, layout, semantics). | 全网最强 DeepSeek Harness 外挂视觉插件，为 DeepSeek、GLM 等纯文本模型外挂视觉能力，粘贴图片即得结构化 JSON 证据（OCR、版面、语义）。

Tags: `agent-skills` `claude-code` `claude-skills` `codex` `cordis` `deepseek` `dsh` `dsh-plugin`

### 3. [dsh-vision-router](https://github.com/ysr666/dsh-vision-router)

⭐ 1,108 · JavaScript · Aktualisiert 2026-09-19

Eyes for text-only DeepSeek Harness agents: built-in free vision chain (no key) + pixel-level vision tools (Q&A, grounding, crop, pixel diff, colors, OCR, SVG trace, cutout, screenshots). One-command install, no Python, image turns work like ordinary tool-calling turns.

Tags: `deepseek-harness` `dsh` `dsh-plugin` `multimodal` `vision`

### 4. [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit)

⭐ 1,094 · Python · Aktualisiert 2026-08-21

为纯文本模型"看图“设计更好的视觉工具箱和技能，支持多图理解，图片问答，前端UI还原、GUI 自动化等，并可选无缝接入多个主流agent，直接识别粘贴图片｜ A vision toolkit and skill designed for text-only llms — image Q&A, long-screenshot OCR, frontend UI restoration, and GUI automation, with optional seamless integration for Codex, Claude Code, Pi, Oh My Pi, and OpenCode

Tags: `agent` `agent-skills` `claude-code` `codex` `computer-use` `deepseek` `dsh-plugin` `glm`

### 5. [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent)

⭐ 194 · JavaScript · Aktualisiert 2026-09-18

Connect DSH to your database for conversational data analysis and actionable business insights.

Tags: `data-agent` `deepseek-harness` `dsh` `dsh-plugin`

### 6. [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil)

⭐ 172 · TypeScript · Aktualisiert 2026-09-16
...
⭐ 113 · JavaScript · Aktualisiert 2026-08-26
...
Tags: `ai-agents` `claude-code` `codex` `coding-agent` `deepseek-harness` `dsh` `dsh-plugin` `mcp`

---

<a id="interfaces"></a>
## Oberflächen (TUI / Desktop / Web)

*Clients für Harness im Terminal, auf dem Desktop oder im Web.*

### 1. [open-design](https://github.com/nexu-io/open-design)

⭐ 96,967 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 67,917 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 27,597 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 20,098 · TypeScript · Aktualisiert 2026-09-18
...
Tags: `ai-studio` `browser-extension` `bun` `chat-management` `chatgpt` `chrome-extension` `claude-ai` `dsh`

### 5. [deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop)

⭐ 18,946 · TypeScript · Aktualisiert 2026-08-24
...
⭐ 13,127 · Python · Aktualisiert 2026-09-19

FreeToken brings datacenter-scale model serving to your desktop. Run massive models locally, fast and efficiently.

Tags: `deepseek-v4` `edge` `glm` `inference` `minimax` `moe` `qwen` `transformer`

### 7. [yao](https://github.com/YaoApp/yao)

⭐ 7,976 · Go · Aktualisiert 2026-09-18
...
⭐ 3,530 · Rust · Aktualisiert 2026-09-19
...
⭐ 3,258 · Rust · Aktualisiert 2026-09-18
...
⭐ 3,145 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 3,091 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 2,929 · JavaScript · Aktualisiert 2026-09-15
...
⭐ 2,280 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 2,206 · TypeScript · Aktualisiert 2026-09-07
...
Tags: `agency-agents` `agent-orchestration` `ai-agents` `autogen-alternative` `claude` `codex` `copilot` `crewai-alternative`

### 18. [deepseek-harness-desktop](https://github.com/dsh-tauri-desk/deepseek-harness-desktop)

⭐ 2,127 · TypeScript · Aktualisiert 2026-09-16
...
⭐ 1,944 · JavaScript · Aktualisiert 2026-09-05
...
Tags: `ai` `ai-tools` `antigravity` `claude-code` `codex` `cursor` `deepseek` `deepseek-harness`

### 20. [TokenTracker](https://github.com/xiufengsun/TokenTracker)

⭐ 1,450 · JavaScript · Aktualisiert 2026-08-29
...
Tags: `ai-coding-tools` `ai-tools` `antigravity` `claude-code` `cli` `codex-cli` `cost-tracker` `cursor`

### 21. [agentrq](https://github.com/agentrq/agentrq)

⭐ 1,086 · Go · Aktualisiert 2026-08-21
...
Tags: `acp-client` `acp-gateway` `agentic-ai` `agentic-workflow` `agents` `claude-code` `deepseek-harness` `deepseek-harness-plugin`

### 22. [dshcode](https://github.com/whitelonng/dshcode)

⭐ 712 · TypeScript · Aktualisiert 2026-09-17

Community desktop companion for DeepSeek Harness — one-click Electron app for macOS and Windows

Tags: `agent` `deepseek` `deepseekharness-plugin` `dsh-plugin` `harness`

### 23. [dsh-browser](https://github.com/Lum1104/dsh-browser)

⭐ 689 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 678 · TypeScript · Aktualisiert 2026-09-19

DSH 桌面宠物：一行命令装好即用的透明动画小桌宠，支持多开、大小位置随心配置；还内置 DIY 素材链，能用 AI 视频自造专属宠物

Tags: `deepseek-harness` `desktop-pet` `dsh` `dsh-plugin`

### 25. [dsh_desktop](https://github.com/myYangyunfan/dsh_desktop)

⭐ 668 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 645 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 628 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 588 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 518 · Java · Aktualisiert 2026-09-19
...
⭐ 478 · Python · Aktualisiert 2026-09-19
...
⭐ 390 · Java · Aktualisiert 2026-09-05
...
⭐ 371 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 333 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 325 · TypeScript · Aktualisiert 2026-09-16
...
⭐ 318 · TypeScript · Aktualisiert 2026-09-18

一套 DSH runtime，Desktop、Web 与 TUI 三种开发体验。

Tags: `ai-agent` `cordis` `deepseek-harness` `dsh` `dsh-plugin` `dsh-plugins`

### 36. [dsh-mobile](https://github.com/Clarklevis1995/dsh-mobile)

⭐ 311 · Kotlin · Aktualisiert 2026-09-18
...
⭐ 296 · TypeScript · Aktualisiert 2026-09-19
...
Tags: `accessibility` `ai-agents` `coding-agent` `deepseek-harness` `dsh` `dsh-plugin` `ios` `ios-simulator`

### 38. [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui)

⭐ 280 · TypeScript · Aktualisiert 2026-09-17
...
⭐ 210 · JavaScript · Aktualisiert 2026-09-14
...
⭐ 184 · TypeScript · Aktualisiert 2026-09-19
...
Tags: `agent-native` `ai-agent` `cryptocurrency` `dsh` `dsh-plugin` `dsh-plugin-desktop` `lightweight-charts` `trading-terminal`
...
Tags: `agent-browser` `browser-automation` `cordis` `deepseek-harness` `dsh` `dsh-better-sidebar` `dsh-plugin` `dshfind`

### 42. [dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel)

⭐ 86 · JavaScript · Aktualisiert 2026-08-20
...
<a id="ecosystem"></a>
## Ökosystem und Marktplätze

*Infrastruktur zum Finden, Installieren und Verwalten von Harness-Projekten.*

### 1. [dsh-web](https://github.com/zhu1090093659/dsh-web)

⭐ 7,749 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 4,146 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 1,466 · Python · Aktualisiert 2026-09-19
...
⭐ 1,422 · Python · Aktualisiert 2026-08-28
...
⭐ 1,209 · JavaScript · Aktualisiert 2026-09-19
...
Tags: `deepseek` `deepseek-harness` `deepseek-harness-plugin` `dsh` `dsh-plugin` `dsh-plugin-market` `dsh-plugins` `mobile`

### 6. [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop)

⭐ 803 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 466 · TypeScript · Aktualisiert 2026-09-19
...
Tags: `deepseekharness` `dsh` `dsh-bundle` `dsh-plugin` `dsh-plugin-desktop` `dsh-plugin-market` `dsh-plugin-verify` `dsh-plugins`

### 8. [dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine)

⭐ 304 · JavaScript · Aktualisiert 2026-09-19
...
⭐ 262 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 165 · JavaScript · Aktualisiert 2026-09-14
...
Tags: `agent` `ai-agents` `cordis` `deepseek-harness` `dsh` `dsh-plugin` `javascript` `llm`

### 11. [dsh-webui-market-plugin](https://github.com/Sanqi-normal/dsh-webui-market-plugin)

⭐ 100 · JavaScript · Aktualisiert 2026-08-22
...
⭐ 90 · JavaScript · Aktualisiert 2026-08-19

Tabbit Broser plugins for Deepseek Harness

Tags: `browser-automation` `browser-use` `deepseek-harness` `dsh-plugin` `dsh-plugin-market` `dsh-plugin-verify` `dsh-plugins` `playwright`
...
*Themes, Skins und visuelle Erweiterungen.*

### 1. [CodeWhale](https://github.com/Hmbown/CodeWhale)

⭐ 40,829 · Rust · Aktualisiert 2026-08-20
...
⭐ 5,748 · TypeScript · Aktualisiert 2026-08-24
...
⭐ 2,130 · TypeScript · Aktualisiert 2026-09-19
...
⭐ 1,723 · JavaScript · Aktualisiert 2026-09-19
...
Tags: `ai-agent` `deepseek` `deepseek-harness` `desktop` `desktop-app` `dsh` `dsh-plugins` `dshdesktop`

### 5. [DSH-Desktop-EAC](https://github.com/zouyuxuan122/DSH-Desktop-EAC)

⭐ 1,622 · JavaScript · Aktualisiert 2026-09-11
...
⭐ 1,265 · JavaScript · Aktualisiert 2026-08-24
...
⭐ 405 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 201 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 175 · JavaScript · Aktualisiert 2026-09-18

DeepSeek Harness 换肤 / 壁纸 / 主题包插件 (dsh-plugin) — 8 套 Mirage 主题、每用户强调色、壁纸2.0、主题包导入导出/分享链接、收藏与随机，纯原生 token 系统实现。

Tags: `deepseek-harness` `dsh` `dsh-plugin` `dsh-plugin-theme` `skin` `theme` `wallpaper`
...
*Verwandte Projekte, die noch nicht anders eingeordnet sind.*

### 1. [ollama](https://github.com/ollama/ollama)

⭐ 181,235 · Go · Aktualisiert 2026-09-19
...
⭐ 104,471 · Python · Aktualisiert 2026-09-19

Noch keine Projektbeschreibung.

### 3. [unsloth](https://github.com/unslothai/unsloth)

⭐ 76,402 · Python · Aktualisiert 2026-09-19

Local UI to run and train LLMs and diffusion models. Supports GGUF, MLX, Qwen3.8, DeepSeek-V4, MiniMax-H3, Gemma 4, FLUX and more.

Tags: `agent` `ai` `chatgpt` `deepseek` `fine-tuning` `gemma` `image-generation` `llama`

### 4. [LlamaFactory](https://github.com/hiyouga/LlamaFactory)

⭐ 74,863 · Python · Aktualisiert 2026-09-19

Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024)

Tags: `agent` `ai` `deepseek` `fine-tuning` `gemma` `gpt` `instruction-tuning` `large-language-models`

### 5. [openinterpreter](https://github.com/openinterpreter/openinterpreter)

⭐ 68,382 · Rust · Aktualisiert 2026-09-19
...
⭐ 39,749 · Makefile · Aktualisiert 2026-09-18
...
⭐ 6,606 · TypeScript · Aktualisiert 2026-09-18
...
⭐ 3,713 · JavaScript · Aktualisiert 2026-09-18
...
⭐ 2,670 · Rust · Aktualisiert 2026-09-14
...
⭐ 80 · JavaScript · Aktualisiert 2026-08-19
...
Lies [CONTRIBUTING.md](CONTRIBUTING.md) und reiche ein Projekt per Issue oder Pull Request ein. Es muss direkt mit DeepSeek Harness verbunden sein und ein öffentliches Repository besitzen.
