...
⭐ 229,219 · TypeScript · 更新於 2026-09-19
...
⭐ 66,878 · JavaScript · 更新於 2026-09-19
...
⭐ 27,223 · TypeScript · 更新於 2026-09-19
...
⭐ 20,186 · JavaScript · 更新於 2026-09-19
...
標籤: `ai` `ai-agent` `artificial-intelligence` `chatgpt` `claude` `claude-code` `codex` `cursor`

### 9. [awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin)

⭐ 16,196 · Python · 更新於 2026-09-19
...
⭐ 15,366 · TypeScript · 更新於 2026-09-19
...
⭐ 11,459 · TypeScript · 更新於 2026-09-19
...
⭐ 7,194 · JavaScript · 更新於 2026-09-19
...
標籤: `agent-skills` `claude-skills` `codex` `deepseek` `deepseek-harness` `developer-tools` `dsh-plugin` `finance-skill`

### 16. [iPolloWork](https://github.com/Devin-AXIS/iPolloWork)

⭐ 6,355 · TypeScript · 更新於 2026-09-19
...
⭐ 5,893 · Python · 更新於 2026-09-19

Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses.

標籤: `agent-control-plane` `agent-harness` `agent-ops` `ai-agents` `codex` `dsh-plugin` `long-horizon` `long-horizon-agents`

### 19. [BrowserSkill](https://github.com/Tencent/BrowserSkill)

⭐ 5,360 · TypeScript · 更新於 2026-09-19
...
⭐ 4,129 · TypeScript · 更新於 2026-09-18
...
⭐ 3,809 · JavaScript · 更新於 2026-09-18
...
⭐ 3,488 · Python · 更新於 2026-09-18

ReMe: Memory Management Kit for Agents - Remember Me, Refine Me.

標籤: `agent` `ai-agents` `dsh-plugin` `memory` `memoryscope` `openclaw` `openclaw-plugin` `qwenpaw`

### 24. [OpenBiliClaw](https://github.com/whiteguo233/OpenBiliClaw)

⭐ 3,335 · Python · 更新於 2026-09-19
...
⭐ 1,734 · JavaScript · 更新於 2026-09-19
...
⭐ 1,725 · JavaScript · 更新於 2026-09-19
...
⭐ 1,436 · TypeScript · 更新於 2026-09-19
...
⭐ 1,391 · JavaScript · 更新於 2026-09-18
...
標籤: `ai-agent` `ai-image-generation-api` `comfyui` `deepseek` `deepseek-harness` `dsh-plugin` `gemini` `image-generation`
...
標籤: `agent-tools` `ai-agents` `android-emulation` `anti-detect-browser` `browser-automation` `browser-fingerprinting` `deepseek-harness` `dsh`

### 56. [dsh-synapse](https://github.com/liangmianya/dsh-synapse)

⭐ 407 · JavaScript · 更新於 2026-09-18
...
⭐ 378 · TypeScript · 更新於 2026-09-19

Open-source CLI, schemas, resolver, and DSH agent tools for DSH Plugin Hub

標籤: `ai-agent` `cli` `deepseek-harness` `developer-tools` `dsh-plugin` `plugin-manager` `typescript`

### 59. [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh)

⭐ 371 · Python · 更新於 2026-09-18
...
⭐ 3,985 · TypeScript · 更新於 2026-09-19
...
⭐ 1,108 · JavaScript · 更新於 2026-09-19
...
⭐ 96,967 · TypeScript · 更新於 2026-09-19
...
⭐ 67,917 · TypeScript · 更新於 2026-09-19
...
⭐ 27,597 · TypeScript · 更新於 2026-09-19
...
⭐ 20,098 · TypeScript · 更新於 2026-09-18
...
⭐ 7,486 · TypeScript · 更新於 2026-09-19
...
⭐ 4,234 · TypeScript · 更新於 2026-09-18
...
⭐ 3,663 · TypeScript · 更新於 2026-09-19
...
⭐ 3,145 · JavaScript · 更新於 2026-09-19
...
⭐ 3,091 · TypeScript · 更新於 2026-09-18
...
⭐ 2,929 · JavaScript · 更新於 2026-09-15
...
⭐ 2,280 · TypeScript · 更新於 2026-09-19
...
⭐ 2,206 · TypeScript · 更新於 2026-09-07
...
標籤: `agency-agents` `agent-orchestration` `ai-agents` `autogen-alternative` `claude` `codex` `copilot` `crewai-alternative`

### 18. [deepseek-harness-desktop](https://github.com/dsh-tauri-desk/deepseek-harness-desktop)

⭐ 2,127 · TypeScript · 更新於 2026-09-16
...
⭐ 1,944 · JavaScript · 更新於 2026-09-05
...
標籤: `agent-native` `ai-agent` `cryptocurrency` `dsh` `dsh-plugin` `dsh-plugin-desktop` `lightweight-charts` `trading-terminal`
...
標籤: `agent-browser` `browser-automation` `cordis` `deepseek-harness` `dsh` `dsh-better-sidebar` `dsh-plugin` `dshfind`
...
⭐ 7,749 · TypeScript · 更新於 2026-09-19
...
⭐ 4,146 · TypeScript · 更新於 2026-09-19
...
⭐ 1,209 · JavaScript · 更新於 2026-09-19
...
標籤: `agent` `deepseek` `deepseek-harness` `deepseek-harness-plugin` `dsh` `dsh-plugin` `harness`

### 7. [jingyun-dsh](https://github.com/jingyunstudio/jingyun-dsh)

⭐ 466 · TypeScript · 更新於 2026-09-19
...
標籤: `deepseekharness` `dsh` `dsh-bundle` `dsh-plugin` `dsh-plugin-desktop` `dsh-plugin-market` `dsh-plugin-verify` `dsh-plugins`

### 8. [dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine)

⭐ 304 · JavaScript · 更新於 2026-09-19
...
⭐ 2,130 · TypeScript · 更新於 2026-09-19
...
⭐ 1,723 · JavaScript · 更新於 2026-09-19
...
⭐ 1,622 · JavaScript · 更新於 2026-09-11
...
⭐ 104,471 · Python · 更新於 2026-09-19

尚無專案簡介。

### 3. [unsloth](https://github.com/unslothai/unsloth)

⭐ 76,402 · Python · 更新於 2026-09-19

Local UI to run and train LLMs and diffusion models. Supports GGUF, MLX, Qwen3.8, DeepSeek-V4, MiniMax-H3, Gemma 4, FLUX and more.

標籤: `agent` `ai` `chatgpt` `deepseek` `fine-tuning` `gemma` `image-generation` `llama`

### 4. [LlamaFactory](https://github.com/hiyouga/LlamaFactory)

⭐ 74,863 · Python · 更新於 2026-09-19
...
⭐ 68,382 · Rust · 更新於 2026-09-19

A coding agent for open models like Kimi K3 and GLM 5.3

標籤: `acp` `coding-agent` `deepseek` `kimi` `python` `qwen` `rust`

### 6. [mindshub](https://github.com/mindsdb/mindshub)

⭐ 39,749 · Makefile · 更新於 2026-09-18
...
⭐ 6,606 · TypeScript · 更新於 2026-09-18
...
標籤: `ai` `ai-agents` `anthropic` `cost-optimization` `deepseek` `gemini` `llm` `llm-router`

### 10. [Awesome-AITools](https://github.com/ikaijua/Awesome-AITools)

⭐ 6,186 · Python · 更新於 2026-09-18
...
⭐ 3,713 · JavaScript · 更新於 2026-09-18
...
標籤: `deepseek` `deepwiki` `dsh-plugin` `grok` `okf-format` `openwiki`
